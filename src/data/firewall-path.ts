...
const ENG_RE =
  /cec|379|starter motor|cranking motor|crank motor|crank motor solenoid|j31|magnetic switch|j30|glow plug|alternator|generator|pump motor|water probe|vacuum switch|fuel heater|on the engine|on trans|speedometer sensor|transmission oil temp \(345\)|fuel sender|headlight \(|horn 605|shutter solenoid|fog light \(|left turn|right turn|ether|662|396|batteries|dual mounted|camshaft|bap |filter \(399\)|inline \(401\)|booster relay \(300\)|hydraulic brake booster|flow switch|diff/i;

const CAB_RE =
  /fuse|key switch|cluster|start relay \(387\)|crank relay \(661\)|431|horn relay|615|wif|399\)|overlay|aps|382|cruise|384|monitor|body builder|wait|j1|interrupt|hyd brake switch|headlight switch|turn switch|flasher/i;
