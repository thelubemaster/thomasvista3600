...
export const relayFaces: RelayFace[] = [
  ...
  },
  {
    ...
    page: "84 / 57",
    where: "Cab — stationary column N/DRL (typical 3600)",
    look: "5-cavity micro. Printed page 84: 1=52C 2=51/51F 3 empty 4=53A 5=51D.",
    engineCritical: false,
    fused: "Unfused 50 from J1 through switch 60",
    layout: "iso5",
    pins: [
      { id: "2", iso: "30", circuit: "51 / 51F", role: "Load in", goes: "HEADLIGHT SWITCH (60) B — 51 12YL", power: "Battery" },
      { id: "1", iso: "87", circuit: "52C", role: "Load out", goes: "Hi 52C to FRONT END (2B) E1", power: "Battery" },
      { id: "4", iso: "87a", circuit: "53A", role: "Load out", goes: "Lo 53A to FRONT END (2B) D1", power: "Battery" },
      { id: "5", iso: "85", circuit: "51D", role: "Coil +", goes: "FTP & LTD CONTROL (192)", power: "Signal" },
      { id: "3", iso: "86", circuit: "---", role: "NC", goes: "Empty on printed page 84", power: "Signal" },
    ],
    more: "Printed page 57. Typical 3600 stationary column. Not a floor dimmer. Pin 3 empty.",
  },
  {
    id: "101",
    tag: "101",
    ...
    page: "84 / 57",
    where: "Cab — FTP N.O. on the turn stalk",
    look: "5-cavity micro. Printed page 84: 1=52C 2=50A/51C 3 empty 4=52B 5=51E.",
    engineCritical: false,
    fused: "D3 30A STOP — 50A 14YL",
    layout: "iso5",
    pins: [
      { id: "2", iso: "30", circuit: "50A / 51C", role: "Load in", goes: "D3 50A and stalk 51C", power: "Battery" },
      { id: "4", iso: "87", circuit: "52B", role: "Load out", goes: "Hi flash 52B", power: "Battery" },
      { id: "1", iso: "87", circuit: "52C", role: "Load in", goes: "Hi bus from LTD", power: "Battery" },
      { id: "5", iso: "85", circuit: "51E", role: "Coil +", goes: "FTP N.O. 51E 18OR", power: "Signal" },
      { id: "3", iso: "86", circuit: "---", role: "NC", goes: "Empty on printed page 84", power: "Signal" },
    ],
    more: "Printed page 57. FTP is fused with STOP on D3. Pin 3 empty.",
  },
  {
    id: "284",
    tag: "284",
