...
export const relayFaces: RelayFace[] = [
  ...
  },
  {
    ...
    look: "ISO 4-cavity. 30=14B battery in, 87=97CT keep-alive out, 85=97AH coil +, 86=97CM coil −.",
    engineCritical: true,
    fused: "C2 10A DIAG + 40A ECM / in-line 14B",
    layout: "iso4",
    pins: [
      { id: "4", iso: "30", circuit: "14B", role: "Load in", goes: "Always-hot battery into the relay (40A ECM / 14B)", power: "Battery" },
      { id: "3", iso: "87", circuit: "97CT", role: "Load out", goes: "CEC keep-alive → CEC and ENGINE DASH (3) F / C2-B", power: "Battery" },
    ...
    more: "Four wires. 30=14B battery in, 87=97CT keep-alive out. Pull this relay and the CEC dies. On the 7.3 the same four circuits are CEC MODULE PWR RELAY W/T444E (662), printed page 104.",
  },
  {
    id: "300",
    tag: "300",
  ...
  },
  {
    ...
    look: "ISO 4-cavity. Same four circuits as 396: 30=14B battery in, 87=97CT keep-alive out, 85=97AH coil +, 86=97CM coil −.",
    engineCritical: true,
    fused: "C2 10A DIAG + 40A ECM / in-line 14B",
    layout: "iso4",
    pins: [
      { id: "4", iso: "30", circuit: "14B", role: "Load in", goes: "Always-hot 14B 10RD into the relay (40A ECM). Not 97AH.", power: "Battery" },
      { id: "3", iso: "87", circuit: "97CT", role: "Load out", goes: "CEC keep-alive 18VT → CEC and ENGINE DASH (3) F / fuse C2-B", power: "Battery" },
      { id: "1", iso: "86", circuit: "97CM", role: "Coil −", goes: "Coil return / CEC logic", power: "Signal" },
      { id: "2", iso: "85", circuit: "97AH", role: "Coil +", goes: "IGN / CEC (tied to C1 97CR path)", power: "Key / IGN" },
    ],
    more: "T444E 7.3 module-power relay. Same pinout as 396 on page 88 — 30 is 14B in, 87 is 97CT out. Pull it and the CEC dies.",
  },
  {
    id: "100",
    tag: "100",
