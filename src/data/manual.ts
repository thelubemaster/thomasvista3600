...
export const manual: ManualEntry[] = [
  ...
  { id: "lt-rebuild", page: "57 / 13 / 63 / 65", title: "LIGHTS — CAB TO WALL REBUILD", section: "Light systems", hyd: "3600 hyd", engineCritical: false, circuits: ["50", "55", "54", "70", "LT"], mapId: "LT", notes: "Headlights, turns, stop, park. Land on FRONT END (2B) and BODY BUILDER (194). Flasher R1, LTD 100, FTP 101." },
