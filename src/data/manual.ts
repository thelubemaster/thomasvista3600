...
export const manual: ManualEntry[] = [
  ...
  { id: "chg3600", page: "18", title: "CHARGING SYSTEM (12V) W/3600 & W/DELCO 1100,130,145 AMP / L/N 1105 & 160 AMP", section: "Engine systems", hyd: "3600", engineCritical: true, circuits: ["1", "2", "7", "26"], mapId: "2", notes: "Alternator J33: I=field 1, B=charge 2 4RD to J1, G=2-G ground. Ammeter 26/26A is a J1 tap through (2) E5/F5. Regulator is internal." },
  ...
  { id: "lt-rebuild", page: "57 / 13 / 63 / 65", title: "LIGHTS — CAB TO WALL REBUILD", section: "Light systems", hyd: "3600 hyd", engineCritical: false, circuits: ["50", "55", "54", "70", "LT"], mapId: "LT", notes: "Headlights 502/504, front 503/505, body stop/turn/marker, panel. 2B and 194 then the lamps. Flasher R1, LTD 100, FTP 101." },
  { id: "hdl-3600", page: "57", title: "HEADLIGHT SYSTEM W/3800,4000FBC & W/005AAA (STATIONARY STRG COLUMN) & N/DRL", section: "Light systems", hyd: "3600", engineCritical: false, circuits: ["50", "51", "52", "53"], mapId: "50", notes: "Typical 3600. LTD relay 100, FTP relay 101. 50 unfused from J1. FTP 50A off D3 30A STOP." },
