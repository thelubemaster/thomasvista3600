...
export const schematicNodes: SchematicNode[] = [
  ...
  { id: "d2", label: "FUSE D2 20A FUEL HTR", sub: "Battery · 19D", kind: "fuse", detail: "19D 10GY into HEATER RELAY (431) pin 30. Pin 87 is the same 19D out to (399) A.", page: "50 / 76" },
  { id: "relay431", label: "HEATER RELAY (431)", sub: "Cab · 4 wires", kind: "module", detail: "30=19D in from D2. 87=19D out to 399-A. 85=19F from the 399-B splice. 86=19E CAB GROUND.", page: "50" },
  { id: "splice19J", label: "SPLICE AT 399-B", sub: "19J / 19F / 19M", kind: "connector", detail: "A2 19J splices at FUEL FILTER (399) B. 19F is 431-85 coil only. 19M is the filter light.", page: "50" },
  { id: "ff399", label: "FUEL FILTER (399)", sub: "Through 6-way · 12 wires", kind: "connector", detail: "Six cavities, two faces. A=19D B=19J C=19H D=19A E=19B F=19C.", page: "50 / 83" },
  { id: "ffMate", label: "399 MATE", sub: "Other end · 6-way", kind: "connector", detail: "Mating half of 399. Same six cavities.", page: "50 / 83" },
...
export const schematicWires: SchematicWire[] = [
  ...
  { id: "w-431-399", from: "relay431", to: "ff399", circuit: "19D", color: "bat", label: "87 → A" },
  { id: "w-a2-399", from: "a2", to: "splice19J", circuit: "19J", color: "ign", label: "to B" },
  { id: "w-splice-399", from: "splice19J", to: "ff399", circuit: "19J", color: "ign", label: "B" },
  { id: "w-splice-431", from: "splice19J", to: "relay431", circuit: "19F", color: "a", label: "85 coil" },
  { id: "w-399-mate-a", from: "ff399", to: "ffMate", circuit: "19D", color: "bat", label: "A → A" },
  { id: "w-399-mate-b", from: "ff399", to: "ffMate", circuit: "19J", color: "ign", label: "B → B" },
  { id: "w-399-mate-c", from: "ff399", to: "ffMate", circuit: "19H", color: "a", label: "C → C" },
  { id: "w-399-mate-d", from: "ff399", to: "ffMate", circuit: "19A", color: "a", label: "D → D" },
  { id: "w-399-mate-e", from: "ff399", to: "ffMate", circuit: "19B", color: "b", label: "E → E" },
  { id: "w-399-mate-f", from: "ff399", to: "ffMate", circuit: "19C", color: "c", label: "F → F" },
