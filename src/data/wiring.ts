...
export const schematicNodes: SchematicNode[] = [
  ...
  { id: "relay431", label: "HEATER RELAY (431)", sub: "Cab · 4 wires", kind: "module", detail: "30=19D in from D2. 87=19D out to 399-A. 85=19F from (399) B. 86=19E CAB GROUND.", page: "50" },
