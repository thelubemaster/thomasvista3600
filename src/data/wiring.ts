...
export const schematicNodes: SchematicNode[] = [
  ...
  { id: "relay431", label: "HEATER RELAY (431)", sub: "Overlay · 4 wires", kind: "module", detail: "30=19D through 399-A from D2. 87=19A straight through 399-D to the firewall heater. No jumper on 19A. 85=19F. 86=19E.", page: "50" },
  ...
  { id: "ff399", label: "FUEL FILTER (399)", sub: "Pass-through 6-way", kind: "connector", detail: "A 19D D2↔431-30. B 19J A2↔overlay. C start↔1CR. D 19A 431-87↔wall. E 19B 470↔wall. F 19C overlay↔wall.", page: "50 / 88" },
...
export const schematicWires: SchematicWire[] = [
  ...
  { id: "w-d2-431", from: "d2", to: "ff399", circuit: "19D", color: "bat", label: "A" },
  { id: "w-431-399", from: "ff399", to: "relay431", circuit: "19D", color: "bat", label: "A → 30" },
  { id: "w-a2-399", from: "a2", to: "ff399", circuit: "19J", color: "ign", label: "B" },
  { id: "w-splice-399", from: "ff399", to: "splice19J", circuit: "19J", color: "ign", label: "B" },
