...
export const schematicNodes: SchematicNode[] = [
  ...
  { id: "ff399", label: "FUEL FILTER (399)", sub: "Through 6-way · 12 wires", kind: "connector", detail: "One plug. Six wires on the cab end, six on the mate end. A=19D B=19J C=19H D=19A E=19B F=19C.", page: "50 / 83" },
