...
export const schematicNodes: SchematicNode[] = [
  ...
  { id: "ff399", label: "FUEL FILTER (399)", sub: "In-line 6-way · cab | overlay", kind: "connector", detail: "Cab face: 431-87, A2 19J, start 19H, 19A/B/C to dash (2). Overlay face: heater / temp / 1CR / 470. D2 to 431-30 does not go through 399.", page: "50 / 88" },
...
export const schematicWires: SchematicWire[] = [
  ...
  { id: "w-399-2a", from: "ff399", to: "bulkhead", circuit: "19A", color: "a", label: "cab D → H5" },
  { id: "w-399-2b", from: "ff399", to: "bulkhead", circuit: "19B", color: "b", label: "cab E → E4" },
  { id: "w-399-2c", from: "ff399", to: "bulkhead", circuit: "19C", color: "c", label: "cab F → H6" },
