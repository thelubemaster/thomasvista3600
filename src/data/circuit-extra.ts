...
export const extras: Record<string, Extra> = {
  ...
  "90": {
    fuse: "E3 10A BRAKE (90B / 90C). Pump current is 90A from J31 through 90-FL.",
    power: "Key + Battery",
    engineCritical: false,
    ifCut: "Hydro-Max pump dies. Engine still runs. Pedal goes hard.",
    cab: "E3-A 90B → (2) A6. E3-B 90C → switch 50 / 49-K. Diode 47/48 and monitor 49 stay in the cab. (2) A7 is 90H into the diode, not the motor.",
