...
export const extras: Record<string, Extra> = {
  ...
  "LT": {
    fuse: "E4 20A HEAD · C3 30A TURN · D3 30A STOP+FTP · E2 30A MARKER.",
    power: "Battery",
    engineCritical: false,
  ...
  "50": {
    ...
    cab: "J1 14A → E4 → switch 60-A 50. 60-B 51 → LTD (100) pin 2. D3 50A → FTP (101) pin 2. Stalk 192 is FTP/LTD. Hi indicator 52A on GREEN (27) 4.",
    ...
    more: "Printed page 57. Typical 3600 stationary column N/DRL. There is no floor dimmer. Rebuild fuses 50 at E4 20A (book empty). D3 30A is STOP and also FTP.",
  },
  "47": {
    fuse: "CEC 5V / sensor",
    power: "Signal",
