...
export const extras: Record<string, Extra> = {
  ...
  "19": {
    ...
    cab: "A2 → 19J → (399) B. D2 → 19D → (399) A and HEATER RELAY (431). 19H from (399) C to start switch.",
    ...
    more: "Only 19A / 19B / 19C cross the firewall. 19D / 19E / 19F / 19H / 19J stay in the cab.",
  },
  "26": {
